...
def get_sources():
    ...
    '''
    get_sources_url = 'http://newsapi.org/v2/sources?&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(api_Key) #construct the news api url
...
def get_top_articles(id):
    ...
    Function that gets the json response to our url request
    '''
    get_articles_url = 'http://newsapi.org/v2/top-headlines?sources={}&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(id, api_Key) #construct the top articles api url
...
def get_keyword(keyword_name):
    search_keyword_url = 'https://newsapi.org/v2/everything?q={}&sortBy=relevancy,publishedAt&pageSize=30&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(keyword_name, api_Key)
...
def get_breaking_news():
    get_breaking_news_url = 'http://newsapi.org/v2/top-headlines?country=us&category=general&apiKey=e152de3bf60b4b5c8a0015230caabe60'.format(api_Key)
